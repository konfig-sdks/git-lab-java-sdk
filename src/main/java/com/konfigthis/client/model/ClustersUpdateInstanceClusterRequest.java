...
public class ClustersUpdateInstanceClusterRequest {
  ...
  public ClustersUpdateInstanceClusterRequest() {
  }

  public ClustersUpdateInstanceClusterRequest name(String name) {
  ...
  **/
  ...
  public ClustersUpdateInstanceClusterRequest enabled(Boolean enabled) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Enable or disable Gitlab's connection to your Kubernetes cluster")
  ...
  public ClustersUpdateInstanceClusterRequest environmentScope(String environmentScope) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The associated environment to the cluster")
  ...
  public ClustersUpdateInstanceClusterRequest namespacePerEnvironment(Boolean namespacePerEnvironment) {
  ...
  **/
  ...
  public ClustersUpdateInstanceClusterRequest domain(String domain) {
  ...
  **/
  ...
  public ClustersUpdateInstanceClusterRequest managementProjectId(Integer managementProjectId) {
  ...
  **/
  ...
  public ClustersUpdateInstanceClusterRequest managed(Boolean managed) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Determines if GitLab will manage namespaces and service accounts for this cluster")
  ...
  public ClustersUpdateInstanceClusterRequest platformKubernetesAttributesApiUrl(String platformKubernetesAttributesApiUrl) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "URL to access the Kubernetes API")
  ...
  public ClustersUpdateInstanceClusterRequest platformKubernetesAttributesToken(String platformKubernetesAttributesToken) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Token to authenticate against Kubernetes")
  ...
  public ClustersUpdateInstanceClusterRequest platformKubernetesAttributesCaCert(String platformKubernetesAttributesCaCert) {
  ...
  **/
  ...
  public ClustersUpdateInstanceClusterRequest platformKubernetesAttributesNamespace(String platformKubernetesAttributesNamespace) {
  ...
  **/
   ...
   * @return the ClustersUpdateInstanceClusterRequest instance itself
   */
  public ClustersUpdateInstanceClusterRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ClustersUpdateInstanceClusterRequest clustersUpdateInstanceClusterRequest = (ClustersUpdateInstanceClusterRequest) o;
    return Objects.equals(this.name, clustersUpdateInstanceClusterRequest.name) &&
        Objects.equals(this.enabled, clustersUpdateInstanceClusterRequest.enabled) &&
        Objects.equals(this.environmentScope, clustersUpdateInstanceClusterRequest.environmentScope) &&
        Objects.equals(this.namespacePerEnvironment, clustersUpdateInstanceClusterRequest.namespacePerEnvironment) &&
        Objects.equals(this.domain, clustersUpdateInstanceClusterRequest.domain) &&
        Objects.equals(this.managementProjectId, clustersUpdateInstanceClusterRequest.managementProjectId) &&
        Objects.equals(this.managed, clustersUpdateInstanceClusterRequest.managed) &&
        Objects.equals(this.platformKubernetesAttributesApiUrl, clustersUpdateInstanceClusterRequest.platformKubernetesAttributesApiUrl) &&
        Objects.equals(this.platformKubernetesAttributesToken, clustersUpdateInstanceClusterRequest.platformKubernetesAttributesToken) &&
        Objects.equals(this.platformKubernetesAttributesCaCert, clustersUpdateInstanceClusterRequest.platformKubernetesAttributesCaCert) &&
        Objects.equals(this.platformKubernetesAttributesNamespace, clustersUpdateInstanceClusterRequest.platformKubernetesAttributesNamespace)&&
        Objects.equals(this.additionalProperties, clustersUpdateInstanceClusterRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, enabled, environmentScope, namespacePerEnvironment, domain, managementProjectId, managed, platformKubernetesAttributesApiUrl, platformKubernetesAttributesToken, platformKubernetesAttributesCaCert, platformKubernetesAttributesNamespace, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ClustersUpdateInstanceClusterRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ClustersUpdateInstanceClusterRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ClustersUpdateInstanceClusterRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClustersUpdateInstanceClusterRequest is not found in the empty JSON string", ClustersUpdateInstanceClusterRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("platform_kubernetes_attributes[api_url]") != null && !jsonObj.get("platform_kubernetes_attributes[api_url]").isJsonNull()) && !jsonObj.get("platform_kubernetes_attributes[api_url]").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("platform_kubernetes_attributes[token]") != null && !jsonObj.get("platform_kubernetes_attributes[token]").isJsonNull()) && !jsonObj.get("platform_kubernetes_attributes[token]").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClustersUpdateInstanceClusterRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClustersUpdateInstanceClusterRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClustersUpdateInstanceClusterRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClustersUpdateInstanceClusterRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ClustersUpdateInstanceClusterRequest>() {
           @Override
           public void write(JsonWriter out, ClustersUpdateInstanceClusterRequest value) throws IOException {
           ...
           @Override
           public ClustersUpdateInstanceClusterRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ClustersUpdateInstanceClusterRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ClustersUpdateInstanceClusterRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ClustersUpdateInstanceClusterRequest
  * @throws IOException if the JSON string is invalid with respect to ClustersUpdateInstanceClusterRequest
  */
  public static ClustersUpdateInstanceClusterRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClustersUpdateInstanceClusterRequest.class);
  }

 /**
  * Convert an instance of ClustersUpdateInstanceClusterRequest to an JSON string
  *
  * @return JSON string
  */
