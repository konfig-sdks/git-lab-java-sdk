...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://www.gitlab.com/api";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("ApiKeyAuth", new ApiKeyAuth("header", "Private-Token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://www.gitlab.com/api)
